...
export const TeamCard: React.FC<TeamMember> = ({name, designation, corner}) => {
  ...
  return (
    <div className={`relative group overflow-hidden rounded-[25px] sm:rounded-[40px] md:rounded-[50px] border border-black flex-1 aspect-[3/2] ${cornerClass} bg-orange-50`}>
      <img src={`/team/${name}.jpg`} alt="Missing" className="size-full object-center grayscale group-hover:grayscale-0" />
