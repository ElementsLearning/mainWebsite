...
export const shopItems: ShopItemType[] = [
  {
    name: "Fraction Board",
    description: "The fraction board provides a tangible representation of fractional concepts through a board divided into equal parts. By playing with the fraction pieces on the board, learners gain a visual understanding of fractions relationships, addition, subtraction, and equivalency.",
    color: "#CFE8BE",
    innerColor: "#B1DA94",
  ...
  {
    name: "Geoboard",
    description: "A geoboard is a board with pegs arranged in a grid. It's used with rubber bands to create shapes and patterns, teaching geometry basics. It loter covers advanced topics like area, perimeter, Symmetry, and congruence",
    color: "#FEE7BD",
    innerColor: "#FED792",
