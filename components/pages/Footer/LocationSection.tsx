        ...
        <div className="flex-1 flex-col text-sm md:text-base flex gap-6">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex gap-2 items-center xl:px-4">
              ...
              <p className="md:text-lg">+92 327 8698770</p>
            </div>
            <div className="flex gap-2 items-center xl:px-4">
