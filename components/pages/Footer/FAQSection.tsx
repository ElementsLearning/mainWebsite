...
export const FAQSection = () => {
  ...
  return (
    <>
    {opened && <div onClick={() => setOpened(undefined)} className="fixed inset-0 bg-black/80 z-50 flex justify-center items-center p-4 sm:p-8">
